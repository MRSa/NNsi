 ...
 * @author MRSa
 */
public class TheCountSceneDB implements IMidpSceneDB
{
    ...
    static public  final int SUMMARY_SCREEN  = 200; // グラフ画面
    ...
    private IMidpScreenCanvas summaryScreen = null;  // グラフ画面

    /**
     *  コンストラクタではなにもしない
     */
    public TheCountSceneDB()
    {
        //
    }
