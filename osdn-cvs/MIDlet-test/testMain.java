...
{
	private final String        APPLICATION_TITLE = "MIDlet-test";
	private testAplSceneSelector sceneSelector = null;
	...
	public testMain()
	{
		...
		// オブジェクトを生成しておく
		sceneSelector = new testAplSceneSelector(this);
	}
	...
	private class splashScreen extends Canvas
	{
		...
		public void paint(Graphics g)
		{
			...
			if (image == null)
			{
				...
				g.setFont(font);
				g.drawString(APPLICATION_TITLE, 0, (getHeight() / 2), (Graphics.LEFT | Graphics.TOP));
				return;
			}
			else
			{
