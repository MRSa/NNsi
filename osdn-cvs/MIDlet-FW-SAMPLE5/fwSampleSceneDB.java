...
public class fwSampleSceneDB  implements IMidpSceneDB
{
    ...
    protected IMidpScreenCanvas directoryCanvas = null;
    ...
    public void setCanvas(IMidpScreenCanvas screen)
    {
        ...
        else if (screen.getCanvasId() == fwSampleFactory.DIR_SCREEN)
        {
            directoryCanvas = screen;
        }
        else
        {
    ...
    public boolean changeScene(int next, int current, String title)
    {
        ...
        else if (next == fwSampleFactory.DIR_SCREEN)
        {
            baseScreen.changeActiveCanvas(directoryCanvas);
        }
        else
        {
            // メイン画面へ切り替える
