 ...
 * @author MRSa
 */
public class LocHuntSceneDB implements IMidpSceneDB
{
    ...
    static public  final int BUSY_SCREEN     = 110; // ビジー表示画面
    static public  final int PREVIEW_SCREEN  = 120; // プレビュー画面
    ...
    private IMidpScreenCanvas busyScreen    = null;  // ビジー表示画面
    private IMidpScreenCanvas previewScreen = null;  // プレビュー画面

    /**
     *  コンストラクタではなにもしない
     */
    public LocHuntSceneDB()
    {
        //
    }
