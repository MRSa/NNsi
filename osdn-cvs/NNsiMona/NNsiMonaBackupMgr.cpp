/*****************************************************************************
 *
 * Generic Conduit CNNsiMonaBackupMgr Src File
 *
 ****************************************************************************/
 ...
 *
 *****************************************************************************/
CNNsiMonaBackupMgr::CNNsiMonaBackupMgr(CPLogging *pLogging, DWORD dwGenericFlags, char *szDbName, TCHAR *pFileName, TCHAR *pDirName, eSyncTypes syncType)
: CNNsiMonaPCMgr(pLogging, dwGenericFlags, szDbName, pFileName, pDirName, syncType)
{
    TRACE0("CNNsiMonaBackupMgr Constructor\n");
 ...
 *
 *****************************************************************************/
CNNsiMonaBackupMgr::~CNNsiMonaBackupMgr()
{
    TRACE0("CNNsiMonaBackupMgr Destructor\n");
}
 ...
 *
 *****************************************************************************/
long CNNsiMonaBackupMgr::Close(BOOL bDontUpdate)
{
 ...
 *
 *****************************************************************************/
long CNNsiMonaBackupMgr::PostSync(void)
{
 ...
 *
 *****************************************************************************/
long CNNsiMonaBackupMgr::OpenDB(void)
{
    long retval = 0;
 ...
 *
 *****************************************************************************/
long CNNsiMonaBackupMgr::PreSync(void)
{
    long retval = 0;
    if (m_bAlreadyLoaded)
        return 0;
