/*
 *  $Id: gikoNaviIndexParser.cpp,v 1.1 2005/05/22 09:35:02 mrsa Exp $
 *
 ...
 *
 */
gikoNaviIndexParser::gikoNaviIndexParser(void) : mParsed(false)
{
	// データを初期化する...
 ...
 *
 */
gikoNaviIndexParser::~gikoNaviIndexParser(void)
{
    // とりあえず何もしない
}
 ...
 *
 */
void gikoNaviIndexParser::setBoardNickName(std::string &arBoardNick)
{
 ...
 *
 */
void gikoNaviIndexParser::setIndexFileName(std::string &arIndexFileName)
{
 ...
 *
 */
void gikoNaviIndexParser::setBoardCategory(std::string &arBoardCategory)
{
 ...
 *
 */
void gikoNaviIndexParser::setBoardName    (std::string &arBoardName)
{
 ...
 *
 */
void gikoNaviIndexParser::setBoardURL     (std::string &arBoardURL)
{
 ...
 *
 */
void gikoNaviIndexParser::setBoardType(int aBoardType)
{
 ...
 *
 */
void gikoNaviIndexParser::getBoardNickName(std::string &arBoardNick)
{
 ...
 *
 */
void gikoNaviIndexParser::getIndexFileName(std::string &arIndexFileName)
{
 ...
 *
 */
void gikoNaviIndexParser::getBoardCategory(std::string &arBoardCategory)
{
 ...
 *
 */
void gikoNaviIndexParser::getBoardName(std::string &arBoardName)
{
 ...
 *
 */
void gikoNaviIndexParser::getBoardURL     (std::string &arBoardURL)
{
 ...
 *
 */
void gikoNaviIndexParser::getBoardType    (int         &arBoardType)
{
 ...
 *
 */
bool gikoNaviIndexParser::parseIndex(void)
{
 ...
 *
 */
BOOL gikoNaviIndexParser::parseIndexFile(char *apBuffer, const DWORD aDataSize, int &arThreadCount)
{
	DWORD parsedSize = 0;
	char *ptr;
 ...
 *
 */
int gikoNaviIndexParser::getThreadCount(void)
{
 ...
 *
 */
void gikoNaviIndexParser::entryThreadRecord(char *apBuffer, DWORD aDataSize)
{
	char              debugTemp[512];
	unsigned int      num = 0;
 ...
 *
 */
bool gikoNaviIndexParser::entryIndexRecord(threadIndexRecord *&arpIndexRecord)
{
...
// インデックスレコードを取得する
bool gikoNaviIndexParser::getIndexRecord(std::string &arFileName, threadIndexRecord *&arpIndexRecord)
{
	map<std::string,threadIndexRecord>::iterator ite;
 ...
 *
 */
void gikoNaviIndexParser::createRecordIndex(void)
{
 ...
 *
 */
bool gikoNaviIndexParser::outputIndexFile(void)
{
	// インデックスファイル名が指定されていないか？
	if (mIndexFileName.length() == 0)
	{
