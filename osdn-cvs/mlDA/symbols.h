/*============================================================================*
 *  $Id: symbols.h,v 1.8 2008/03/08 20:03:26 mrsa Exp $
 *
 *  FILE: 
 *     symbols.h
 *
...
#define ISP_YAHOO_BB_MOBILE           6   // Yahoo! BB Mobileの記憶領域
#define ISP_BIZPORTAL                 5   // Bizportalの記憶領域
...
/** タイムアウト時間の設定 **/
#define NNSH_GETMAIL_TIMEOUT         45
