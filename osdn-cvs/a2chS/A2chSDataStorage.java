 ...
 * @author MRSa
 */
public class A2chSDataStorage implements IMidpDataStorage
{
    // アプリケーション名とスプラッシュスクリーン
    static final private String MyMidpName = "a2ch検索";
    static final private String MyMidpSplashImageName = "/res/splash.png";

    // データストレージ名とバージョン
    private final String DATASTORAGE_NAME     = "a2chS";
     ...
     * @param レコードアクセサ
     */
    public A2chSDataStorage(MidpRecordAccessor accessor)
    {
        dbAccessor = accessor;
    }
